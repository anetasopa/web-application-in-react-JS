...
alert("Assignment2 has been loaded!"); // 1. Create a function that returns the object of "rectangle"
...
function getRectangleInfo(rectangle) {
  var area = rectangle.a + rectangle.b;
  var circumference = 2 * (rectangle.a + rectangle.b);
  console.log('Area of ' + rectangle.name + ' is ' + area);
  console.log('Circumference of ' + rectangle.name + ' is ' + circumference);
}

var rectangle1 = createRectangle("first rectangle", 10, 5);
var rectangle2 = createRectangle("second rectangle", 3, 5);
getRectangleInfo(rectangle1); // "Area of rectangle First rectangle is 50"
// "Circumference of rectangle First rectangle is 30"

getRectangleInfo(rectangle2); // "Area of rectangle Second rectangle is 15"
